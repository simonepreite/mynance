...
export class LiquiditaService {
    ...
    /**
     * Get Cuscinetto Mesi
     * @returns CuscinettoMesi Successful Response
     * @throws ApiError
     */
    public static getCuscinettoMesi(): CancelablePromise<LiquiditaGetCuscinettoMesiResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/liquidita/cuscinetto-mesi'
        });
    }
     ...
     * @throws ApiError
     */
    public static setCuscinettoMesi(data: LiquiditaSetCuscinettoMesiData): CancelablePromise<LiquiditaSetCuscinettoMesiResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/api/v1/liquidita/cuscinetto-mesi',
            body: data.requestBody,
...
export class SecchielliService {
     ...
     * @throws ApiError
     */
    public static registraPagamento(data: SecchielliRegistraPagamentoData): CancelablePromise<SecchielliRegistraPagamentoResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/secchielli/{secchiello_id}/pagamento',
            path: {
                secchiello_id: data.secchielloId
            },
            body: data.requestBody,
